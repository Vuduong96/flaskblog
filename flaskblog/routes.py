...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your username and password have been updated!', 'success')
...
def update_post(post_id):
    ...
    if post.author != current_user:
        abort(403) # 403: HTTP response for forbidden route
    form = PostForm()
    if form.validate_on_submit():
...
#make sure the given token is active
